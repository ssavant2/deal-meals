...
from tests.run_matcher_layer_fixture_cases import _load_fixture_payload  # noqa: E402
from tests.run_matcher_layer_parity import DEFAULT_FIXTURE_FILE, run_parity  # noqa: E402
...
def main() -> int:
    ...
    check("case count", summary["cases"], 1463)
    check("passed count", summary["passed"], 1463)
    ...
    check("diagnosis counts", report["diagnosis_counts"], {"pass": 1463})
