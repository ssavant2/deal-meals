...
DEFAULT_REPORT_DIR = APP_DIR / "tests" / "reports" / "verified_term_audit"
...
def _classify_static_variant(
    ...
    *,
    ...
    if source_type == "matcher_rule_inventory":
        ...
        from tests.matcher_layer_diagnostics import diagnose_case
        from tests.run_matcher_layer_fixture_cases import (
