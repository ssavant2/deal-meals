...
# runtime_ksbc_potatis_nypotatis: generated by dm matcher add ksbc
# sanity-id: runtime_ksbc_potatis_nypotatis
from languages.sv.ingredient_matching import KEYWORD_SUPPRESSED_BY_CONTEXT
test("KSBC potatis has nypotatis",
     "nypotatis" in KEYWORD_SUPPRESSED_BY_CONTEXT.get("potatis", set()), True)
