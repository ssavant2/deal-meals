...
# ingredient_parent_granatapple_granatappelkarnor: generated by dm matcher add ingredient-parent
# sanity-id: ingredient_parent_granatapple_granatappelkarnor
test("ingredient-parent Granatäpple Jumbo Klass 1 ICA matches granatäpple",
     match("Granatäpple Jumbo Klass 1 ICA", "Granatäppelkärnor", "pantry"), "granatäpple")
