...
# keyword_synonym_fetaost_salladsost: generated by dm matcher add keyword-synonym
# sanity-id: keyword_synonym_fetaost_salladsost
test("Keyword synonym salladsost matches fetaost",
     match("Fetaost Kassos", "salladsost", ""), "fetaost")
# ingredient_parent_pasta_risoni: generated by dm matcher add ingredient-parent
# sanity-id: ingredient_parent_pasta_risoni
test("ingredient-parent Fusilli Pasta Barilla matches pasta",
     match("Fusilli Pasta Barilla", "Risoni", ""), "risoni")
