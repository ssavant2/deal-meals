...
test("PNB philadelphiaost has vegansk",
     "vegansk" in PRODUCT_NAME_BLOCKERS.get("philadelphiaost", set()), True)
...
test("PNB philadelphiaost has plant based",
     "plant based" in PRODUCT_NAME_BLOCKERS.get("philadelphiaost", set()), True)
test("PNB philadelphiaost has växtbaserad",
     "växtbaserad" in PRODUCT_NAME_BLOCKERS.get("philadelphiaost", set()), True)
...
# runtime_pnb_salame_vegan: generated by dm matcher add pnb
# sanity-id: runtime_pnb_salame_vegan
from languages.sv.ingredient_matching import PRODUCT_NAME_BLOCKERS
test("PNB salame has vegan",
     "vegan" in PRODUCT_NAME_BLOCKERS.get("salame", set()), True)
