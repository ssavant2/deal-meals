...
# runtime_ksbc_margarin_mjolkfritt: generated by dm matcher add ksbc
from languages.sv.ingredient_matching import KEYWORD_SUPPRESSED_BY_CONTEXT
test("KSBC margarin has mjölkfritt",
     "mjölkfritt" in KEYWORD_SUPPRESSED_BY_CONTEXT.get("margarin", set()), True)
test("KSBC margarin has mjolkfritt",
     "mjolkfritt" in KEYWORD_SUPPRESSED_BY_CONTEXT.get("margarin", set()), True)
test("KSBC margarin has mjölkfri",
     "mjölkfri" in KEYWORD_SUPPRESSED_BY_CONTEXT.get("margarin", set()), True)
test("KSBC margarin has mjolkfri",
     "mjolkfri" in KEYWORD_SUPPRESSED_BY_CONTEXT.get("margarin", set()), True)
