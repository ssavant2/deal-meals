...
test("offer-extra-keyword Vitlöksost ca 500g Gäsene Mejeri matches färskost",
     match("Vitlöksost ca 500g Gäsene Mejeri", "200 g färskost", "pantry"), "färskost")
...
test("offer-extra-keyword Vaccaost 150g Wapnö matches fetaost",
     match("Vaccaost 150g Wapnö", "200 g fetaost", "pantry"), "fetaost")
...
test("offer-extra-keyword Matlagningsost Riven 12% 150g ICA matches gratängost",
     match("Matlagningsost Riven 12% 150g ICA", "200 g gratängost", "pantry"), "gratängost")

# offer_extra_keyword_dessertost_vitmogelost: generated by dm matcher add offer-extra-keyword
test("offer-extra-keyword White chili vitmögelost 150g Castello matches dessertost",
     match("White chili vitmögelost 150g Castello", "200 g dessertost", "pantry"), "dessertost")
...
test("offer-extra-keyword Chaumes 25% ca 170g Falbygdens ost matches dessertost",
     match("Chaumes 25% ca 170g Falbygdens ost", "200 g dessertost", "pantry"), "dessertost")
