...
# offer_extra_keyword_inlagdgurka_smorgasgurka: generated by dm matcher add offer-extra-keyword
test("offer-extra-keyword Smörgåsgurka matches inlagdgurka",
     match("Smörgåsgurka", "smörgåsgurka", "pantry"), "inlagdgurka")
