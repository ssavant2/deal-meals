...
# runtime_pnb_gradde_soja: generated by dm matcher add pnb
# sanity-id: runtime_pnb_gradde_soja
from languages.sv.ingredient_matching import PRODUCT_NAME_BLOCKERS
test("PNB grädde has soja",
     "soja" in PRODUCT_NAME_BLOCKERS.get("grädde", set()), True)
