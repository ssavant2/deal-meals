...
MATCHER_HASH_FILES = (
    ...
    "app/languages/sv/ingredient_matching/dietary_exclusions.py",
    ...
    "app/languages/sv/ingredient_matching/match_bridges.py",
    ...
    "app/languages/sv/ingredient_matching/no_match_policies.py",
    ...
    *TERM_REGISTRY_HASH_FILES,
    ...
    "app/languages/sv/ingredient_matching/rule_models.py",
