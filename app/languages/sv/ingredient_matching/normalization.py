...
_SPACE_NORMALIZATIONS: List[Tuple[str, str]] = [
    ...
    ('creme av sol torkade tomater', 'soltorkadetomatcreme'),
    ('creme sol torkade tomater', 'soltorkadetomatcreme'),
    ('creme av soltorkade tomater', 'soltorkadetomatcreme'),
    ('creme soltorkade tomater', 'soltorkadetomatcreme'),
    ('kräm av sol torkade tomater', 'soltorkadetomatcreme'),
    ('kräm sol torkade tomater', 'soltorkadetomatcreme'),
    ('kräm av soltorkade tomater', 'soltorkadetomatcreme'),
    ('kräm soltorkade tomater', 'soltorkadetomatcreme'),
    ('kram av sol torkade tomater', 'soltorkadetomatcreme'),
    ('kram sol torkade tomater', 'soltorkadetomatcreme'),
    ('kram av soltorkade tomater', 'soltorkadetomatcreme'),
    ('kram soltorkade tomater', 'soltorkadetomatcreme'),
    ('soltorkad tomatcreme', 'soltorkadetomatcreme'),
    ('soltorkad tomat creme', 'soltorkadetomatcreme'),
    ('soltorkad tomat-creme', 'soltorkadetomatcreme'),
    ('soltorkad tomatkräm', 'soltorkadetomatcreme'),
    ('soltorkad tomat kräm', 'soltorkadetomatcreme'),
    ('soltorkad tomat-kräm', 'soltorkadetomatcreme'),
    ('soltorkad tomatkram', 'soltorkadetomatcreme'),
    ('soltorkad tomat kram', 'soltorkadetomatcreme'),
    ('soltorkad tomat-kram', 'soltorkadetomatcreme'),
