...
./bin/dm matcher add pnb ...
./bin/dm matcher add fpb ...
./bin/dm matcher add ksbc ...
./bin/dm matcher add gpb ...
./bin/dm matcher add stop-word ...
./bin/dm matcher add non-food-keyword ...
./bin/dm matcher add space-normalization ...
./bin/dm matcher add dual-keyword-normalization ...
./bin/dm matcher add flavor-word ...
./bin/dm matcher add carrier-product ...
./bin/dm matcher add important-short-keyword ...
./bin/dm matcher add processed-food ...
./bin/dm matcher add processed-rule ...
./bin/dm matcher add processed-exemption ...
./bin/dm matcher add strict-processed-rule ...
./bin/dm matcher add spice-fresh-rule ...
./bin/dm matcher add cuisine-context ...
./bin/dm matcher add compound-protection ...
./bin/dm matcher add specialty-qualifier ...
./bin/dm matcher add qualifier-equivalent ...
...
./bin/dm matcher batch start|status|finalize --dry-run|metrics --start|metrics --finish|abort
...
unclear. Supported runtime data surfaces should go through `dm matcher add` so
