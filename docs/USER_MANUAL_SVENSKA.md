...
Ange ingrediensord du vill undvika. Vanliga ord som `gluten`, `nötter`,
`skaldjur`, `ägg`, `soja` och `laktos` tolkas som enkla best-effort-profiler
som använder recepttexter, varunamn och kända matchningsregler. Andra ord
fortsätter fungera som enklare varunamnsfilter.

Funktionen kan hjälpa till att minska oönskade träffar, men den är inte en
medicinsk allergisäkerhetsfunktion. Kontrollera alltid recept och
produktmärkning själv om en ingrediens är viktig av allergi-, intolerans- eller
hälsoskäl.
...
- **Förkryddad och marinerad råvara** — produkter som "Kycklingfilé Örtkryddad", "Fläskkarré BBQ-marinerad" eller "Laxfilé Citronmarinerad" visas som förslag även om receptet inte specifikt ber om den kryddningen. Det är medvetet: produkterna är fortfarande råa råvaror och du väljer själv om du vill använda den förkryddade varianten. Att blockera dem helt skulle ta bort dem som alternativ från alla recept — även de där de passar utmärkt. **Undantag:** Färdiglagade kycklingprodukter (stekt, rostad, deli-skivad) visas inte för råvaruingredienser, oavsett hur produkten är kryddad.
- **Kryddning kopplad till en specifik matkulturell profil** — produkter med en tydlig koppling till en specifik matstil visas bara i recept av matchande typ. "Thaikryddad kycklingfilé" dyker alltså inte upp som förslag i ett franskt timjansrecept, men visas i wok- och thairecept. "Tacokryddad fläskfärs" visas bara i taco- och texmexrecept. Gyrosmarinerat kött i grekiska recept. Det gör att dessa produkter fortfarande syns och kan köpas — men bara för rätt typ av maträtt.
